...
MarvelFutureFight.prototype.runAutoCowork = function(task) {
  ...
  while (task.isRunning) {
    // try next
    console.log("[MMFS][Co-Op] try to next");
    if (rbm.imageClick("next.1920x1080.png")) {
      sleep(10000); continue;
    }
    // enter the lobby
    console.log("[MMFS][Co-Op] check at lobby");
    if (rbm.imageExists("lobby.1920x1080.png")) {
      sleep(1000);
      // get awards
