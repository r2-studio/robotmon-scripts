...
export const pageInCookieGacha = [
...
export const rfpageNameYourKingdom = new Page('rfpageNameYourKingdom', pageNameYourKingdom, pageNameYourKingdom[0]);

export const pageStoryBuildCookieHouses1 = [
...
export const rfpageStoryBuildCookieHouses1 = new Page('rfpageStoryBuildCookieHouses1', pageStoryBuildCookieHouses1, pageStoryBuildCookieHouses1[0]);

export const pageKindomHasOnlySorageAndBuildIcon = [
...
export const rfpageKindomHasOnlySorageAndBuildIcon = new Page('rfpageKindomHasOnlySorageAndBuildIcon', pageKindomHasOnlySorageAndBuildIcon);
export const pageKingdomHaveNoCookieIcon = [
...
export const rfpageFountain3rdRawEmpty = new Page(
  'rfpageFountain3rdRawEmpty',
  [
    { x: 505, y: 305, r: 121, g: 207, b: 12 },
    { x: 569, y: 310, r: 219, g: 207, b: 199 },
    { x: 368, y: 23, r: 60, g: 70, b: 105 },
...
export const rfpageBattleFinished = new Page(
...
export const pageIslandSunbedWithWetCookie = [
...
export const pageBattleFinishedWithMVPCookie = [
...
export const pageNeedRefillBounties2 = [
...
export const pageAllianceResults = [
...
export const pageAllianceResults2 = [
...
export const rfpageBattleFinishedWithMVPCookieWithExit = new Page(
...
export const rfpageNeedRefillBounties = new Page('rfpageNeedRefillBounties', pageNeedRefillBounties, { x: 428, y: 82 });
export const rfpageNeedRefillBounties2 = new Page('rfpageNeedRefillBounties2', pageNeedRefillBounties2, { x: 442, y: 82 });
...
export const rfpageKeepBattleByOrderNotCheck = new Page('rfpageKeepBattleByOrderNotCheck', pageKeepBattleByOrderNotCheck, pageKeepBattleByOrderNotCheck[0]);
export const rfpageInTowerOfSweetChaos = new Page(
...
export const pageCookieKingdomIsNotResponding = [
...
export const rfpageCookieKingdomIsNotResponding = new Page(
  'rfpageCookieKingdomIsNotResponding',
  pageCookieKingdomIsNotResponding,
  pageCookieKingdomIsNotResponding[0]
);

export const pageCookieKingdomIsNotResponding2 = [
...
export const rfpageCookieKingdomIsNotResponding2 = new Page(
  'rfpageCookieKingdomIsNotResponding2',
  pageCookieKingdomIsNotResponding2,
  pageCookieKingdomIsNotResponding2[0]
);

export const pageCookieKingdomHasStopped = [
  { x: 484, y: 205, r: 0, g: 150, b: 136 },
  { x: 478, y: 205, r: 238, g: 238, b: 238 },
  { x: 440, y: 172, r: 238, g: 238, b: 238 },
  { x: 402, y: 169, r: 57, g: 57, b: 57 },
];
export const rfpageCookieKingdomHasStopped = new Page('rfpageCookieKingdomHasStopped', pageCookieKingdomHasStopped, pageCookieKingdomHasStopped[0]);

export const rfpageInCookieHead = new Page('rfpageInCookieHead', [
...
export const pagePurchaseDiamond = [
...
export const rfpagePurchaseDiamond = new Page('rfpagePurchaseDiamond', pagePurchaseDiamond);

export const pageCanGotoKingdom = [
...
export const pageCookieKingdomNotResponding = [
...
export const rfpageCookieKingdomNotResponding = new Page('rfpageCookieKingdomNotResponding', pageCookieKingdomNotResponding, pageCookieKingdomNotResponding[0]);

export const pageGooglePlaystoreHasStopped = [
...
export const rfkingdomPassItemCollected = new Page(
  'rfkingdomPassItemCollected',
  [
...
export const rfpageWorldChat = new Page(
  'rfpageWorldChat',
  [
...
export const rfpageCanSendFriendRewards = new Page(
  'rfpageCanSendFriendRewards',
  [
