config = {
    ...
    autoCollectTrainIntervalInMins: 10,
  ...
  function handleFindAndTapCandyHouse() {
    ...
    // ]
    var directions = [Directions.SE, Directions.SW, Directions.SE, Directions.NE, Directions.NE, Directions.NW, Directions.SW];
    ...
    console.log('Try tap candy: ', findAndTapCandy());
  
    if (findAndTapProductionHouse()) {
      console.log('already found house using image match, start working');
      return true;
    }
    // else if (findHouseInNotSureWhere(config.findProductionTimes)) {
  ...
  function handleInputLoginInfo() {
    ...
    if (inputEmail) {
      pageEnterpassword = [
        { x: 377, y: 152, r: 255, g: 255, b: 255 },
        { x: 430, y: 41, r: 48, g: 58, b: 80 },
        { x: 378, y: 192, r: 200, g: 200, b: 200 },
        { x: 315, y: 191, r: 200, g: 200, b: 200 },
        { x: 315, y: 148, r: 255, g: 255, b: 255 },
        { x: 289, y: 129, r: 255, g: 255, b: 255 },
        { x: 301, y: 117, r: 255, g: 255, b: 255 },
        { x: 296, y: 118, r: 52, g: 52, b: 52 },
        { x: 361, y: 57, r: 60, g: 60, b: 60 },
        { x: 319, y: 55, r: 230, g: 230, b: 230 },
      ];
  ...
  function findAndTapFountain() {
    ...
    if (waitUntilSeePage(pageInFountain, 8)) {
      qTap(pageInFountain);
      sleep(config.sleepAnimate * 3);
      console.log('Fountain collected successfully')
    }
  
    handleTryHitBackToKingdom();
    console.log('Claim Fountain job done!')
    return true;
  }
  ...
  function handleTrain() {
    ...
    pageTrainCollapsed = [
      {x: 98, y: 328, r: 255, g: 224, b: 139},
      {x: 123, y: 301, r: 255, g: 0, b: 0},
      {x: 128, y: 344, r: 40, g: 66, b: 97},
      {x: 58, y: 342, r: 44, g: 77, b: 102},
      {x: 417, y: 321, r: 134, g: 18, b: 10},
      {x: 27, y: 224, r: 225, g: 157, b: 77}
    ]
    pageInTrainStation = [
  ...
  function zoomOut() {
    console.log('aa')
    tapDown(230, 130, 100, 0);
    tapDown(200, 100, 100, 1);
    sleep(config.sleep)
  ...
  function handleGetDailyRewards() {
    ...
    if (checkIsPage(pageGacha)) {
      ...
      if (checkIsPage(pageDailyGift)) {
        qTap(pageDailyGift);
        sleep(config.sleepAnimate * 2);
    
        pageClaim = [
          {x: 516, y: 318, r: 121, g: 207, b: 12},
          {x: 617, y: 313, r: 121, g: 207, b: 12},
          {x: 523, y: 18, r: 0, g: 130, b: 249}
        ]
        if (checkIsPage(pageClaim)) {
          qTap(pageClaim);
          handleGotoKingdomPage();
        }
      }
  ...
  function start(inputConfig) {
    ...
    for (var i = 1; i < 100000000; i++) {
      ...
      if (config.autoCollectTrainIntervalInMins != -1 && ((Date.now() - config.lastCollectTrain) / 60000) > config.autoCollectMailInterval) {
        console.log('Collect train: ', (Date.now() - config.lastCollectTrain) / 60000, ' just passed');
