...
"use strict";
function TaskController() { this.tasks = {}, this.isRunning = !1, this.interval = 200; }
TaskController.prototype.getFirstPriorityTaskName = function () { var t = null, n = Date.now(); for (var s in this.tasks) {
    var i = this.tasks[s];
    n - i.lastRunTime < i.interval || (null !== t ? i.priority < t.priority ? t = i : i.interval > t.interval ? t = i : i.lastRunTime < t.lastRunTime && (t = i) : t = i);
} return null === t ? "" : t.name; }, TaskController.prototype.loop = function () { for (console.log("loop start"); this.isRunning;) {
    var t = this.getFirstPriorityTaskName(), n = this.tasks[t];
    void 0 !== n && (n.run(), n.lastRunTime = Date.now(), n.runTimes--, 0 === n.runTimes && delete this.tasks[t]), sleep(this.interval);
} this.isRunning = !1, console.log("loop stop"); }, TaskController.prototype.updateRunInterval = function (t) { t < this.interval && t >= 50 && (this.interval = t); }, TaskController.prototype.newTaskObject = function (t, n, s, i, o) { return { name: t, run: n, interval: s || 1e3, runTimes: i || 0, priority: o, lastRunTime: 0, status: 0 }; }, TaskController.prototype.newTask = function (t, n, s, i, o) { if (void 0 === o && (o = !1), "function" == typeof n) {
    var e = this.newTaskObject(t, n, s, i, 0);
    o && (e.lastRunTime = Date.now()), this.updateRunInterval(e.interval);
    var r = "system_newTask_" + t, a = this.newTaskObject(r, function () { this.tasks[t] = e; }.bind(this), 0, 1, -20);
    return this.tasks[r] = a, e;
} console.log("Error not a function", t, n); }, TaskController.prototype.removeTask = function (t) { var n = "system_removeTask_" + Date.now().toString(), s = this.newTaskObject(n, function () { delete this.tasks[t]; }.bind(this), 0, 1, -20); this.tasks[n] = s; }, TaskController.prototype.removeAllTasks = function () { var t = "system_removeAllTask_" + Date.now().toString(), n = this.newTaskObject(t, function () { for (var t in this.tasks)
    delete this.tasks[t]; }.bind(this), 0, 1, -20); this.tasks[t] = n; }, TaskController.prototype.start = function () { this.isRunning || (this.isRunning = !0, this.loop()); }, TaskController.prototype.stop = function () { this.isRunning && (this.isRunning = !1, console.log("wait loop stop...")); };
var ts;
var gTaskController;
// Utils
...
function findLongestTsumPath(neighbors, comp, budgetPerStart) {
    ...
    for (var s = 0; s < maxStarts; s++) {
        ...
        if (globalBest.length >= comp.length) {
            break;
        }
    }
            ...
            for (var y = 720; y < 1380 && !foundMickey; y += 25) {
                for (var x = 120; x < 1000 && !foundMickey; x += 60) {
                    ...
                    if (foundMickey) {
                        ...
                        left.x -= 10;
                        right.x += 10;
                        foundMickey = (isSameColor(colorMickeyFace, this.getColor(img, up), 20)
...
Tsum.prototype.taskPlayGameQuick = function () {
    ...
    while (this.isRunning) {
        ...
        if (this.useFan && this.runTimes % 4 === 3) {
            ...
            var skillStatus = this.checkSkillReadiness(fanImg, Button.gameSkill1);
            releaseImage(fanImg);
            if (skillStatus === 'far') {
                this.tap(Button.gameRand, 60);
                this.tap(Button.gameRand, 60);
