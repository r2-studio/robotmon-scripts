# Builds TsumThi and copies dist\* into the MuMu shared folder so the emulator
...
$TargetDir = Join-Path $env:USERPROFILE "OneDrive\Documents\MuMuSharedFolder\Download\Robotmon\scripts\com.r2studio.TsumThi"
