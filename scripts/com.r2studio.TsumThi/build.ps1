...
if ($ADB -and $Device) {
    ...
    adb -s $Device push .\dist\index.js "sdcard\Download\Robotmon\scripts\com.r2studio.TsumThi\"
    if ($?) {
    ...
    adb -s $Device push .\dist\index.html "sdcard\Download\Robotmon\scripts\com.r2studio.TsumThi\"
    if ($?) {
