...
// TODO:  add battle mode (ranked), special mode for solve weekly mission

var versionCode = 13.6;
...
var gDuringMaxAdRetry = 2 * 60 * 1000;
...
var gGameLineUpPage = new RF.Page(
  ...
  [
    ...
    // buttons in bottom
    { x: 78, y: 328, r: 24, g: 64, b: 113 },
    { x: 115, y: 327, r: 65, g: 107, b: 145 },
    { x: 171, y: 323, r: 255, g: 255, b: 255 },
    { x: 200, y: 324, r: 172, g: 195, b: 221 },
    { x: 225, y: 324, r: 19, g: 68, b: 129 },
    { x: 271, y: 326, r: 255, g: 255, b: 255 },
    { x: 294, y: 325, r: 125, g: 158, b: 192 },
    { x: 310, y: 326, r: 197, g: 219, b: 234 },
    { x: 367, y: 325, r: 255, g: 255, b: 255 },
    { x: 393, y: 324, r: 48, g: 91, b: 146 },
    { x: 414, y: 324, r: 176, g: 200, b: 224 },
    { x: 534, y: 317, r: 17, g: 63, b: 114 },
    { x: 542, y: 327, r: 24, g: 69, b: 123 },
    { x: 561, y: 324, r: 209, g: 227, b: 244 },
    { x: 589, y: 326, r: 88, g: 128, b: 164 },
    // back
...
var gAchivementMissionPage = new RF.Page(
  ...
  [
    ...
    { x: 141, y: 323, r: 238, g: 235, b: 238 },
    { x: 624, y: 11, r: 214, g: 210, b: 214 },
    { x: 595, y: 14, r: 74, g: 93, b: 123 },
    { x: 495, y: 10, r: 247, g: 197, b: 49 },
    { x: 501, y: 14, r: 88, g: 80, b: 56 },
    { x: 482, y: 17, r: 214, g: 210, b: 214 },
    { x: 388, y: 12, r: 197, g: 200, b: 197 },
    { x: 391, y: 17, r: 95, g: 95, b: 95 },
    { x: 320, y: 15, r: 144, g: 148, b: 149 },
    { x: 312, y: 9, r: 238, g: 234, b: 238 },

    // today's mission
    { x: 234, y: 60, r: 214, g: 214, b: 222 },
    { x: 243, y: 63, r: 51, g: 59, b: 68 },
    { x: 271, y: 62, r: 67, g: 73, b: 84 },
    { x: 311, y: 65, r: 60, g: 65, b: 76 },
    { x: 329, y: 61, r: 149, g: 154, b: 161 },
    { x: 370, y: 71, r: 214, g: 214, b: 222 },

    // complete weekly mission box
    { x: 235, y: 262, r: 230, g: 231, b: 230 },
    { x: 275, y: 261, r: 230, g: 231, b: 230 },
    { x: 309, y: 265, r: 54, g: 63, b: 70 },
    { x: 354, y: 265, r: 164, g: 168, b: 172 },
    { x: 312, y: 279, r: 230, g: 231, b: 238 },
    { x: 249, y: 282, r: 218, g: 218, b: 226 },

    // back btn
    { x: 24, y: 314, r: 214, g: 215, b: 214 },
    { x: 41, y: 318, r: 214, g: 219, b: 214 },
    { x: 34, y: 331, r: 214, g: 219, b: 214 },
  ],
...
var gWeeklyMissionBoxPage = new RF.Page(
  ...
  { x: 0, y: 0 }, // complete weekly mission box
  { x: 0, y: 0 }
);
...
MLB9I.prototype.start = function () {
  ...
  // TODO: check adReward is paid feature or not
  // this.addTask(
...
// * =========== task ===========
MLB9I.prototype.addTask = function (taskName, taskRunCount, isRepeat) {
  var taskState = {
    runCount: 0,
  ...
  switch (taskName) {
    ...
    // TODO: check how to make it run once/ day
    default:
      break;
  }
  this.taskQue.push({
...
MLB9I.prototype.runTasks = function () {
  while (this.taskQue.length > 0 && this.isRunning) {
    if (this.config.isXr) {
      ...
      var now = Date.now();
      if (now - this.lastRestartTimestamp >= 864000000) {
...
MLB9I.prototype.handleAchivementMissionPage = function () {
  ...
  for (y = 128; y < 260; y += 44) {
    ...
    var canCollect =
      rgb.r === canCollectBtn.r &&
      rgb.g === canCollectBtn.g &&
      rgb.b === canCollectBtn.b;
    if (canCollect) {
...
MLB9I.prototype.handleLeagueModePanelPageNextSchedule = function () {
  ...
  // FIXME: cancel return if test run is ok
  return RF.Utils.sleep(gSleepPageLong);
  ...
  var isStillOnPage =
    gLeagueModePanelPageNextSchedule.isMatchImage(screenshot) ||
    gLeagueModePanelPageNextSchedule2.isMatchImage(screenshot) ||
    gLeagueModePanelPageContinue.isMatchImage(screenshot);
  releaseImage(screenshot);
...
MLB9I.prototype.handleLeagueModeNewGamePage = function () {
  ...
  var bgColor = { r: 25, g: 36, b: 49 };
  var hasEnergy10 = false;
  for (var y = 273; y < 286 && !hasEnergy10; y++) {
    for (var x = 563; x > 544; x--) {
      var rgb = getImageColor(screenshot, x, y);
      if (rgb.r === bgColor.r && rgb.g === bgColor.g && rgb.b === bgColor.b) {
        continue;
      }
      hasEnergy10 = true;
      break;
  ...
  releaseImage(screenshot);
  var isQuickPlayOn = rgb.r === 33 && rgb.g === 255 && rgb.b === 140;
...
function start(jsonConfig) {
  ...
  console.log(JSON.stringify(mlb9i.start));
  mlb9i.start();
}
function stop() {
  if (mlb9i === undefined) {
