...
MLB9I.prototype.handleRankedBattlePanelPage = function () {
  ...
  var screenshot = getScreenshot();
  var disabledPlayBtn = { x: 595, y: 328, r: 49, g: 57, b: 49 };
  var rgb = getImageColor(screenshot, disabledPlayBtn.x, disabledPlayBtn.y);
  var isPlayDisabled = isSameColor(rgb, disabledPlayBtn);
...
MLB9I.prototype.handleRankedBattleGameInfoPage = function () {
  if (this.task !== TASK.playBattleGame) {
    gRankedBattleGameInfoPage.goBack(this.screen);
    return;
  }
  gRankedBattleGameInfoPage.goNext(this.screen);
};
...
MLB9I.prototype.handleLeagueModeGameInfoPage = function () {
  if (this.task !== TASK.playLeagueGame) {
    gLeagueModeGameInfoPage.goBack(this.screen);
    return;
  }
