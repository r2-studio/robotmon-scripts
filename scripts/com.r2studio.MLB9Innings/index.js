...
MLB9I.prototype.handleAchivementMissionPage = function () {
  ...
  // TODO: collect daily one if available
};
...
MLB9I.prototype.handleLeagueModePanelPageNextSchedule = function () {
  ...
  RF.Utils.sleep(gSleepPageLong);
};
MLB9I.prototype.handleLeagueModePanelPageContinue = function () {
  console.log("is enter next schedule page");
  if (this.task !== TASK.playLeagueGame) {
    gLeagueModePanelPageContinue.goBack(this.screen);
    return;
  }
...
MLB9I.prototype.handleLeagueModeNewGamePage = function () {
  ...
  for (var y = 274; y < 286 && !hasEnergy10; y++) {
    for (var x = 552; x < 564; x++) {
