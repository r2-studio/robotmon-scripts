...
var gEndSeasonPage = new RF.Page(
  "gSeasonEndPage",
  [
    { x: 102, y: 34, r: 2, g: 83, b: 149 },
    { x: 158, y: 32, r: 93, g: 147, b: 193 },
    { x: 241, y: 30, r: 27, g: 103, b: 166 },
    { x: 301, y: 34, r: 255, g: 255, b: 255 },
    { x: 355, y: 33, r: 255, g: 255, b: 255 },
    { x: 403, y: 34, r: 252, g: 253, b: 254 },
    { x: 469, y: 34, r: 255, g: 255, b: 255 },
    { x: 544, y: 34, r: 212, g: 227, b: 240 },
    { x: 569, y: 29, r: 196, g: 215, b: 233 },
    { x: 624, y: 10, r: 0, g: 97, b: 181 },
    { x: 8, y: 11, r: 0, g: 97, b: 181 },
    { x: 8, y: 344, r: 8, g: 16, b: 8 },
    { x: 627, y: 347, r: 16, g: 20, b: 8 },
    { x: 315, y: 188, r: 14, g: 17, b: 14 },
    { x: 13, y: 194, r: 41, g: 44, b: 41 },
    { x: 618, y: 192, r: 16, g: 18, b: 16 },
    { x: 512, y: 322, r: 0, g: 117, b: 255 },
    { x: 556, y: 328, r: 255, g: 255, b: 255 },
    { x: 567, y: 323, r: 216, g: 231, b: 254 },
    { x: 597, y: 321, r: 0, g: 117, b: 255 },
    { x: 612, y: 332, r: 8, g: 105, b: 247 },
  ],
  { x: 567, y: 335 },
  { x: 567, y: 335 }
);
...
var gLeagueOnQuickPlayPage = new RF.Page(
  ...
  [
    ...
    // to diff from pause page
    { x: 433, y: 334, r: 0, g: 52, b: 132 },
    { x: 433, y: 320, r: 8, g: 125, b: 255 },
  ],
  { x: 0, y: 0 },
  { x: 0, y: 0 }
);
...
var gLeagueOnQuickPlayPausePage = new RF.Page(
...
var gTeamSupportPackagePromotionPage = new RF.Page(
  ...
  [
    { x: 214, y: 45, r: 76, g: 163, b: 128 },
    { x: 226, y: 42, r: 8, g: 32, b: 41 },
    { x: 245, y: 45, r: 90, g: 190, b: 148 },
    { x: 268, y: 45, r: 8, g: 34, b: 41 },
    { x: 309, y: 42, r: 21, g: 55, b: 58 },
    { x: 345, y: 43, r: 55, g: 127, b: 106 },
    { x: 394, y: 42, r: 8, g: 34, b: 41 },
    { x: 413, y: 43, r: 11, g: 38, b: 45 },
    { x: 574, y: 39, r: 83, g: 179, b: 141 },
    { x: 586, y: 45, r: 54, g: 87, b: 72 },
    { x: 592, y: 47, r: 144, g: 206, b: 177 },
...
var gQuitGamePage1 = new RF.Page(
  "gQuitGamePage1",
  [
...
MLB9I.prototype.goToPage = function (
  ...
  function goTo(tryTime) {
    ...
    if (pageName === "gSelectRewardPlayerPage") {
...
MLB9I.prototype.goMainPage = function () {
  return this.goToPage(gMainPage, 120, gSleepShort, true);
};
...
MLB9I.prototype.handleMvpPage = function () {
  ...
  for (
    var maxOkButtonRemain = 3;
    rgb.r === 38 && rgb.g === 120 && rgb.b === 218 && maxOkButtonRemain;
    maxOkButtonRemain--
  ) {
...
MLB9I.prototype.handleSelectRewardPlayer = function () {
  ...
  var positions = Object.keys(gSelectRewardPlayerPageButtons);

  // TODO: check the color
  for (var i in positions) {
    var pos = gSelectRewardPlayerPageButtons[positions[i]];
...
MLB9I.prototype.handleLeagueModeNextSchedulePage = function () {
  ...
  function goNewGamePanel(tryTime) {
    ...
    // FIXME: handle random pages ex mainPage
    RF.Utils.sleep(gSleepShort);
    return false;
  }

  var isEnterNewGamePanel = this.tryDo(goNewGamePanel.bind(this), 30);
  while (!isEnterNewGamePanel && this.running) {
    isEnterNewGamePanel = this.tryDo(goNewGamePanel.bind(this), 30);
  }
  ...
  while (!isEnterGame && this.running) {
    isEnterGame = this.tryDo(enterGame.bind(this), 150);
  }
  if (!isEnterGame) {
...
MLB9I.prototype.handleEnterLeagueGame = function () {
  console.log("handle enter league game");
  var hasError = false;
  function enterGame(tryTime) {
    ...
    if (pageName === "gLeagueModePanelPageContinue") {
      ...
      RF.Utils.sleep(gSleepMedium);
      x.goNext(this.screen); // play ball
      RF.Utils.sleep(gSleepMedium);
      return true;
    }
...
MLB9I.prototype.handlePlayGame = function () {
  ...
  function endPlaying(tryTime) {
    ...
    if (gMvpPage.isMatchImage(screenshot)) {
      releaseImage(screenshot);
      this.handleMvpPage();
      RF.Utils.sleep(gSleepMedium);
      return false;
    ...
    if (gSelectRewardPlayerPage.isMatchImage(screenshot)) {
      releaseImage(screenshot);
      this.handleSelectRewardPlayer();
      RF.Utils.sleep(gSleepMedium);
      return false;
    ...
    while (pageName !== "" && this.running) {
      console.log("still playing");

      // handle play operation settings
      switch (pageName) {
        case "gLeagueOnQuickPlayPage":
          this.screen.tap({ x: 0, y: 0 });
          console.log("tap");
          RF.Utils.sleep(gSleepLong);
          break;

        case "gLeagueOnQuickPlayPausePage":
          gLeagueOnQuickPlayPausePage.goNext(this.screen);
          RF.Utils.sleep(gSleepWaitPageLong);
          break;
        ...
        case "gLeagueOnPlayPagePowerSaveOn":
          if (
            !gPowerSavingPage.isMatchScreen(this.screen) &&
            this.config.isXr
          ) {
        ...
        case "gLeagueOnPlayPageAutoOff1":
          gLeagueOnPlayPageAutoOff1.goNext(this.screen);
          RF.Utils.sleep(gSleepShort);
        // not break here to click twice and handle power save play
      ...
      pageName = gLeagueOnPlayPagesGroup.waitScreenForMatchingOne(
        this.screen,
        gSleepLong,
        1
      );
    ...
    // handle animation page
    var pages = this.findPages();
    pageName = pages[0];
    var page = this.getPageByName(pageName);
    for (var i = 0; i < 10 && page === null && this.running; i++) {
      this.screen.tap({ x: 0, y: 0 });
      console.log("tap");
      RF.Utils.sleep(gSleepShort);
  ...
  var isEndGame = this.tryDo(endPlaying.bind(this), 150);
  return isEndGame;
};
...
MLB9I.prototype.handleLeagueModePanelPageContinue = function () {
  console.log("is enter next schedule page");
  gLeagueModePanelPageContinue.goNext(this.screen);
  RF.Utils.sleep(gSleepMedium);
};
MLB9I.prototype.handleLeagueNewGamePage = function () {
  console.log("check energy");
...
// play process pages
MLB9I.prototype.handleLeagueNewGamePageSelectPlayRole = function () {
  console.log("handle select play role");
  gLeagueNewGamePageSelectPlayRole.goNext(this.screen);
  return true;
};
...
// on play pages
MLB9I.prototype.handleLeagueOnQuickPlayPage = function () {
  this.screen.tap({ x: 0, y: 0 });
  console.log("tap");
};
MLB9I.prototype.handleLeagueOnQuickPlayPausePage = function () {
  gLeagueOnQuickPlayPausePage.goNext(this.screen);
};
...
MLB9I.prototype.handleLeagueOnPlayPagePowerSaveOn = function () {
  if (!gPowerSavingPage.isMatchScreen(this.screen) && this.config.isXr) {
    console.log("still play with power save on");
  } else {
    this.handlePowerSavingPage();
  }
};
MLB9I.prototype.handleLeagueOnPlayPageAutoOff1 = function () {
  gLeagueOnPlayPageAutoOff1.goNext(this.screen);
};
...
MLB9I.prototype.handleNextPage2 = function () {
  console.log("next2 page");
  gNextPage2.goNext(this.screen);
};
...
MLB9I.prototype.frameworkZack = function () {
  while (this.running) {
    var isAppOn = this.isAppOn();
    if (!isAppOn) {
      console.log("not in app");
    ...
    if (typeof this[handler] === "function") {
      ...
      console.log(JSON.stringify(this[handler]));
