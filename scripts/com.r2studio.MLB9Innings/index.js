...
var gLeagueModeNewGamePageQuickPlayOn = new RF.Page(
  "gLeagueModeNewGamePageOnQuickPlayOn",
  [
    { x: 292, y: 9, r: 214, g: 213, b: 214 },
    { x: 314, y: 7, r: 255, g: 251, b: 255 },
    { x: 379, y: 3, r: 214, g: 215, b: 214 },
...
var gLeagueModeNewGamePageQuickPlayOff = new RF.Page(
  "gLeagueModeNewGamePageOnQuickPlayOff",
  [
    { x: 292, y: 9, r: 214, g: 213, b: 214 },
    { x: 314, y: 7, r: 255, g: 251, b: 255 },
    { x: 379, y: 3, r: 214, g: 215, b: 214 },
...
// * =========== task ===========
MLB9I.prototype.setTask = function (taskName) {
  console.log(this.task, "runs: ", this.taskState.runCount);
  console.log("set task: ", taskName);
  if (this.task !== "") {
    // TODO: force current task stopped and return homepage
  }
  this.task = taskName;
  this.taskState = {
    runCount: 0,
...
MLB9I.prototype.runTask = function (taskName, maxTaskRunCount) {
  this.setTask(taskName);
  while (
    this.running &&
    this.task === taskName &&
    (maxTaskRunCount === undefined || this.taskState.runCount < maxTaskRunCount)
  ) {
...
MLB9I.prototype.start = function () {
  ...
  this.running = true;
  if (this.config.isDev) {
    this.runTask(TASK.changeGameSettings, /* runtimes */ 1);
  }
  this.runTask(TASK.playLeagueGame);
};
...
MLB9I.prototype.handleLeagueModeNewGamePage = function () {
  ...
  if (
    has10Energy &&
    gLeagueModeNewGamePageQuickPlayOff.isMatchImage(screenshot)
  ) {
    gLeagueModeNewGamePageQuickPlayOff.goNext(this.screen); // select quick play
    console.log("turn on quick play");
  } else if (
    !has10Energy &&
    gLeagueModeNewGamePageQuickPlayOn.isMatchImage(screenshot)
  ) {
    gLeagueModeNewGamePageQuickPlayOn.goNext(this.screen); // cancel quick play
